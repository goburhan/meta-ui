...
var Accordion$1 = function (_a) {
    ...
    return (React.createElement(Container$5, null,
        React.createElement(TopMenuEntry, { onClick: handleClick, className: className, onMouseOver: function () { return setActiveAccordion(label); }, onMouseLeave: function () { return setActiveAccordion(''); } },
            ...
            isOpen ? React.createElement(Icon$8, null) : React.createElement(Icon$7, null)),
        React.createElement(AccordionContent$1, { onMouseOver: function () { return setActiveAccordion(label);  }, style: { background :"#fff"  } , onMouseLeave: function () { return setActiveAccordion(''); }, isOpen: activeAccordion === label, isPushed: isPushed, maxHeight: React.Children.count(children) * MENU_ENTRY_HEIGHT }, children ) ) );
};
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "white", background: "#1E2225", backgroundDisabled: "#3c3742", contrast: "#E6F8F1", invertedContrast: "#191326", input: "#d6cda3", primaryDark: "#0098A1", tertiary: "rgba(255,255,255,0.45)", text: "#96906f", textDisabled: "#666171", textSubtle: "#448c9a", borderColor: "#524B63", card: "transparent", white: '#FFFFFF',calloptionbutton:"#ffffB3" ,gradients: {
